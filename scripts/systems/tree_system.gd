...
const POSITIONS := [Vector2(1720,180), Vector2(1960,230), Vector2(2220,180), Vector2(1810,700), Vector2(1860,760), Vector2(2320,650), Vector2(1160,760), Vector2(1320,735)]
