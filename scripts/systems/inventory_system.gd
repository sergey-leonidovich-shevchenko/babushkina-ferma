...
const ITEM_DATA := {
	...
	"tomato_seeds": {"name": "Семена томата", "short": "Томат", "color": Color("c94438"), "seed_bag": true, "tool": 1},
	"cabbage_seeds": {"name": "Семена капусты", "short": "Капуста", "color": Color("65a64f"), "seed_bag": true, "tool": 1},
	"wheat_seeds": {"name": "Семена пшеницы", "short": "Пшеница", "color": Color("d9aa38"), "seed_bag": true, "tool": 1},
	"corn_seeds": {"name": "Семена кукурузы", "short": "Кукуруза", "color": Color("e0bd39"), "seed_bag": true, "tool": 1},
	"potato_seeds": {"name": "Семенной картофель", "short": "Картофель", "color": Color("a77642"), "seed_bag": true, "tool": 1},
	"onion_seeds": {"name": "Семена лука", "short": "Лук", "color": Color("d59a47"), "seed_bag": true, "tool": 1},
	"pumpkin_seeds": {"name": "Семена тыквы", "short": "Тыква", "color": Color("e66d2f"), "seed_bag": true, "tool": 1},
	"strawberry_seeds": {"name": "Семена клубники", "short": "Клубника", "color": Color("d64565"), "seed_bag": true, "tool": 1},
	"beet_seeds": {"name": "Семена свёклы", "short": "Свёкла", "color": Color("a43f76"), "seed_bag": true, "tool": 1},
	"pepper_seeds": {"name": "Семена перца", "short": "Перец", "color": Color("de4738"), "seed_bag": true, "tool": 1},
	"cucumber_seeds": {"name": "Семена огурца", "short": "Огурец", "color": Color("4f9d4a"), "seed_bag": true, "tool": 1},
	"sunflower_seeds": {"name": "Семена подсолнуха", "short": "Подсолнух", "color": Color("d5a02e"), "seed_bag": true, "tool": 1},
	"cotton_seeds": {"name": "Семена хлопка", "short": "Хлопок", "color": Color("78b7d8"), "seed_bag": true, "tool": 1},
	"melon_seeds": {"name": "Семена дыни", "short": "Дыня", "color": Color("d8b53a"), "seed_bag": true, "tool": 1},
	"herb_seeds": {"name": "Семена лечебных трав", "short": "Травы", "color": Color("7651b5"), "seed_bag": true, "tool": 1},
	...
	"advanced_fishing_rod": {"name":"Улучшенная удочка","short":"Удочка+","color":Color("3f78a8"),"tool":5},
	"crab_trap": {"name":"Крабовая ловушка","short":"Ловушка","color":Color("ad743b")},
	...
	"strawberry": {"name": "Садовая клубника", "short": "Клубника", "color": Color("df4253"), "edible": true},
	"beet": {"name": "Сладкая свёкла", "short": "Свёкла", "color": Color("a63b73"), "edible": true},
	"pepper": {"name": "Сладкий перец", "short": "Перец", "color": Color("df4435"), "edible": true},
	"cucumber": {"name": "Хрустящий огурец", "short": "Огурец", "color": Color("4b9849"), "edible": true},
	"sunflower": {"name": "Головка подсолнуха", "short": "Подсолнух", "color": Color("d9a329")},
	"melon": {"name": "Золотая дыня", "short": "Дыня", "color": Color("ddb847"), "edible": true},
	"herbs": {"name": "Лечебные травы", "short": "Травы", "color": Color("7556a5")},
	...
	"log": {"name": "Дубовое бревно", "short": "Бревно", "color": Color("93572f")},
	"plank": {"name": "Дубовые доски", "short": "Доски", "color": Color("d39845")},
	"nails": {"name": "Кованые гвозди", "short": "Гвозди", "color": Color("687784")},
	...
	"fence_kit":{"name":"Секция забора","short":"Забор","color":Color("a87642")}, "gate_kit":{"name":"Набор калитки","short":"Калитка","color":Color("d2a34c")},
