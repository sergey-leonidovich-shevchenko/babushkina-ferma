...
static func use_rod(game: Node) -> bool:
	...
	if game.fishing_state == "idle":
		game.fishing_state = "casting"; game.fishing_timer = 2.5; game.message = "Поплавок в воде... жди поклёвки"; return true
	if game.fishing_state == "ready":
		game.fish += 1; game.fishing_state = "idle"; game.message = "Поймана речная рыба!"; game.notify_tutorial("fish"); return true
