...
static func draw_player(game: Node2D) -> void:
	...
	game.draw_living_atlas_sprite(game.HERO_PROGRESSION_ATLAS, source, position + attack_offset, Vector2(82, 82), game.walk_animation_time, moving, 0.0, false, hero_modulate)
