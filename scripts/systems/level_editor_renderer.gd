...
static func draw_panel(game: Node2D) -> void:
	...
	draw_button(game,game.LevelEditorSystem.SELECT_TOOL_BUTTON,"ВЫБОР",state.tool=="select"); draw_button(game,game.LevelEditorSystem.PAINT_TOOL_BUTTON,"КИСТЬ",state.tool=="paint"); draw_button(game,game.LevelEditorSystem.FILL_TOOL_BUTTON,"ЗАЛИВКА",state.tool=="fill"); draw_button(game,game.LevelEditorSystem.PICKER_TOOL_BUTTON,"ПИПЕТКА",state.tool=="picker"); draw_button(game,game.LevelEditorSystem.ERASE_TOOL_BUTTON,"ЛАСТИК",state.tool=="erase")
