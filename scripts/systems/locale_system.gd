...
const TUTORIAL := {
	...
	"debug_inspector":["F10: кликай объекты, ставь паузу, шагай кадр и проверяй хитбоксы","F10: click objects, pause, frame-step, and inspect hitboxes","F10: inspecciona objetos, pausa y avanza por cuadros","F10: Objekte prüfen, pausieren und Einzelbilder schalten","F10 : inspecte, mets en pause et avance image par image","F10：点击对象、暂停、逐帧并检查碰撞框"],
