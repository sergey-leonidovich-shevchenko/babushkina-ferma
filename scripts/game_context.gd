...
const InterfaceRenderer := preload("res://scripts/systems/interface_renderer.gd"); const ItemWindowRenderer := preload("res://scripts/systems/item_window_renderer.gd")
...
const MenuSystem := preload("res://scripts/systems/menu_system.gd"); const MenuRenderer := preload("res://scripts/systems/menu_renderer.gd"); const SettingsSystem := preload("res://scripts/systems/settings_system.gd"); const UiPreviewSystem := preload("res://scripts/systems/ui_preview_system.gd")
