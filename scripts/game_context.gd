...
const FarmLifeSystem := preload("res://scripts/systems/farm_life_system.gd"); const FarmLifeRenderer := preload("res://scripts/systems/farm_life_renderer.gd"); const FirstChapterSystem := preload("res://scripts/systems/first_chapter_system.gd"); const FirstChapterRenderer := preload("res://scripts/systems/first_chapter_renderer.gd")
