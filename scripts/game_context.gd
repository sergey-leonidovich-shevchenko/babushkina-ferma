...
const MenuSystem := preload("res://scripts/systems/menu_system.gd"); const MenuRenderer := preload("res://scripts/systems/menu_renderer.gd"); const SettingsSystem := preload("res://scripts/systems/settings_system.gd"); const UiPreviewSystem := preload("res://scripts/systems/ui_preview_system.gd"); const UiFeedbackSystem := preload("res://scripts/systems/ui_feedback_system.gd"); const UiFeedbackRenderer := preload("res://scripts/systems/ui_feedback_renderer.gd")
