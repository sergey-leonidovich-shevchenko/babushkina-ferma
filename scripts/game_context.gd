...
const SkillSystem := preload("res://scripts/systems/skill_system.gd"); const TalentSystem := preload("res://scripts/systems/talent_system.gd"); const SpellSystem := preload("res://scripts/systems/spell_system.gd"); const SpellRenderer := preload("res://scripts/systems/spell_renderer.gd")
...
const BuildingSystem := preload("res://scripts/systems/building_system.gd"); const BuildingVisualSystem := preload("res://scripts/systems/building_visual_system.gd")
...
const VisualAssetSystem := preload("res://scripts/systems/visual_asset_system.gd"); const EnvironmentVisualSystem := preload("res://scripts/systems/environment_visual_system.gd"); const PotionSystem := preload("res://scripts/systems/potion_system.gd"); const AnimationAssetRegistry := preload("res://scripts/systems/animation_asset_registry.gd")
...
const ContractSystem := preload("res://scripts/systems/contract_system.gd"); const AdventurePolishSystem := preload("res://scripts/systems/adventure_polish_system.gd"); const AdventurePolishRenderer := preload("res://scripts/systems/adventure_polish_renderer.gd"); const ActionEffectVisualSystem := preload("res://scripts/systems/action_effect_visual_system.gd")
...
const VillageForegroundRenderer := preload("res://scripts/systems/village_foreground_renderer.gd"); const VillageLayoutSystem := preload("res://scripts/systems/village_layout_system.gd"); const VillageAmbientRenderer := preload("res://scripts/systems/village_ambient_renderer.gd"); const WaterVisualSystem := preload("res://scripts/systems/water_visual_system.gd"); const WorldLootRenderer := preload("res://scripts/systems/world_loot_renderer.gd")
const DebugPlaygroundSystem := preload("res://scripts/systems/debug_playground_system.gd"); const DebugPlaygroundRenderer := preload("res://scripts/systems/debug_playground_renderer.gd"); const DebugUiKitSystem := preload("res://scripts/systems/debug_ui_kit_system.gd"); const DebugOverlaySystem := preload("res://scripts/systems/debug_overlay_system.gd"); const DebugOverlayRenderer := preload("res://scripts/systems/debug_overlay_renderer.gd"); const DebugBalanceSystem := preload("res://scripts/systems/debug_balance_system.gd"); const DebugMissionSystem := preload("res://scripts/systems/debug_mission_system.gd"); const DebugMissionRenderer := preload("res://scripts/systems/debug_mission_renderer.gd"); const DebugObjectInspectorSystem := preload("res://scripts/systems/debug_object_inspector_system.gd"); const DebugObjectInspectorRenderer := preload("res://scripts/systems/debug_object_inspector_renderer.gd"); const InteriorVisualSystem := preload("res://scripts/systems/interior_visual_system.gd"); const InteriorRenderer := preload("res://scripts/systems/interior_renderer.gd"); const VillageEventRenderer := preload("res://scripts/systems/village_event_renderer.gd"); const WorldPolishRenderer := preload("res://scripts/systems/world_polish_renderer.gd"); const LevelEditorSystem := preload("res://scripts/systems/level_editor_system.gd"); const LevelEditorRenderer := preload("res://scripts/systems/level_editor_renderer.gd"); const PublishedLevelSystem := preload("res://scripts/systems/published_level_system.gd"); const PublishedLevelRenderer := preload("res://scripts/systems/published_level_renderer.gd"); const FenceSystem := preload("res://scripts/systems/fence_system.gd"); const FenceRenderer := preload("res://scripts/systems/fence_renderer.gd")
const FarmLifeSystem := preload("res://scripts/systems/farm_life_system.gd"); const FarmLifeVisualSystem := preload("res://scripts/systems/farm_life_visual_system.gd"); const FarmLifeRenderer := preload("res://scripts/systems/farm_life_renderer.gd"); const FirstChapterSystem := preload("res://scripts/systems/first_chapter_system.gd"); const FirstChapterRenderer := preload("res://scripts/systems/first_chapter_renderer.gd")
const MenuSystem := preload("res://scripts/systems/menu_system.gd"); const MenuRenderer := preload("res://scripts/systems/menu_renderer.gd"); const SettingsSystem := preload("res://scripts/systems/settings_system.gd"); const UiScaleSystem := preload("res://scripts/systems/ui_scale_system.gd"); const UiVisualRegressionSystem := preload("res://scripts/systems/ui_visual_regression_system.gd"); const UiLayoutAuditSystem := preload("res://scripts/systems/ui_layout_audit_system.gd"); const UiPreviewSystem := preload("res://scripts/systems/ui_preview_system.gd"); const UiFeedbackSystem := preload("res://scripts/systems/ui_feedback_system.gd"); const UiFeedbackRenderer := preload("res://scripts/systems/ui_feedback_renderer.gd")
