...
const FarmLifeSuite = preload("res://tests/suites/farm_life_suite.gd"); const WorldFarmingSuite = preload("res://tests/suites/world_farming_suite.gd"); const LevelEditorSuite = preload("res://tests/suites/level_editor_suite.gd")
var passed := 0
var failed := 0
...
func _initialize() -> void:
	...
	FarmLifeSuite.new(self).run(); WorldFarmingSuite.new(self).run(); LevelEditorSuite.new(self).run()
