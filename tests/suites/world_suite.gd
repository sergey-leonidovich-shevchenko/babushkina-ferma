...
func test_discoveries_and_tutorial_checklist_are_saved() -> void:
	...
	var required_events := ["move","village_paths","character_animation","forage_harvest","forage_regrow","forage_sale","plant","rewater","trade","fight","hotbar","equipment","fish_cast","fish_hook","fish_control","fish","craft_window","story_chain","side_quests","mission_complete","journal","side_mission","colored_crystal","day","level_up","skill_point","profession","pause_menu","settings","save","wildlife","world_loot","watermelon","potion","shield","lizard"]
