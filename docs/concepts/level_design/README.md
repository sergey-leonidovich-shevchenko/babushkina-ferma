...
После полного переноса географии стартовая усадьба находится южнее узкой реки, деревня собрана отдельным центром на северном берегу, а восточная окраина ведёт через второй мост к мельнице и приключениям.

![Дом, огород и южная усадьба](implemented_relayout_home.png)

![Центральная деревенская площадь](implemented_relayout_village.png)

![Восточная окраина, лес и мельница](implemented_relayout_frontier.png)
