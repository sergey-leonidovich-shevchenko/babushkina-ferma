...
| --- | --- |
| `player_system.gd` | Движение, здоровье, опыт, временные эффекты и кадр героя |
...
| `fishing_system.gd` | Конечный автомат рыбалки |
| `combat_system.gd` | Враги, атаки, урон и таблицы боевой добычи |
...
| `quest_system.gd` | Сюжетные и побочные миссии, цели, состояния и награды |
...
5. `_process` обновляет время, существ, эффекты и автоматы состояний.
6. `game_renderer` читает итоговое состояние и рисует кадр в стабильном порядке слоёв.
